...
public class LoginBaseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            fragmentManager .beginTransaction()
                            .replace(R.id.frameContainer, new Login_Fragment(), BaseActivity.Login_Fragment)
                            .commit();
        }
    ...
    protected void replaceLoginFragment() {
        fragmentManager
                ...
                .replace(R.id.frameContainer, new Login_Fragment(),
                        BaseActivity.Login_Fragment).commit();
    }
    ...
    public void onBackPressed() {
        ...
        Fragment SignUp_Fragment = fragmentManager
                .findFragmentByTag(BaseActivity.SignUp_Fragment);
        Fragment ForgotPassword_Fragment = fragmentManager
                .findFragmentByTag(BaseActivity.ForgotPassword_Fragment);
